...
router.get(
  "/:settlement_id",
  validateReq(vendorSettlementValidation.findById),
  vendorSettlementController.findById
);
router.get(
  "/store/:store_id",
