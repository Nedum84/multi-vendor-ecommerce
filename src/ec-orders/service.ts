...
import { FundingTypes, PaymentChannel, PaymentStatus } from "./types";
...
const processRefund = async (req: Request) => {
  ...
  const deliveredAtTillNow = moment(sub_order.delivered_at).add(RETURNABLE_DAYS_MILLISECONDS, "d"); //or day, days
