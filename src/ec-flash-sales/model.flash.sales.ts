...
export interface FlashSalesInstance
  extends Model<FlashSalesAttributes, FlashSalesAttributes>,
    FlashSalesAttributes {}
...
export function FlashSalesFactory(sequelize: Sequelize) {
  const FlashSales = <ModelStatic<FlashSalesInstance>>sequelize.define(
    "FlashSales",
    FlashSalesModelAttributes as any,
    {
      timestamps: true,
