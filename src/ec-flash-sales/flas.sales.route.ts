...
import flashSalesValidation from "./flash.sales.validation";
...
router.get(
  "/:flash_sale_id",
  validateReq(flashSalesValidation.findById),
  flashSaleController.findById
);
...
router.post(
  "/",
  validateReq(flashSalesValidation.createFlashSale),
  flashSaleController.createFlashSale
);
router.patch(
  "/:flash_sale_id",
  validateReq(flashSalesValidation.updateFlashSale),
