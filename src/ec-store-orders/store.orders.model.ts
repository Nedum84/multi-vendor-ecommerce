...
import { OrdersInstance } from "../ec-orders/orders.model";
import { StoreOrdersProductInstance } from "../ec-store-orders-products/store.orders.product.model";
...
interface StoreOrdersCreationAttributes extends Optional<StoreOrdersAttributes, "store_order_id"> {}
