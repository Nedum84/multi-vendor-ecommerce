 ...
 * createTable "SubOrders", deps: [Orders, Store]
 ...
 * createTable "SubOrdersProduct", deps: [SubOrders]
 ...
 * addIndex "sub_orders_order_id" to table "SubOrders"
 * addIndex "sub_orders_store_id" to table "SubOrders"
 * addIndex "orders_payment_order_id" to table "OrdersPayment"
 * addIndex "sub_orders_product_sub_order_id" to table "SubOrdersProduct"
...
var migrationCommands = [{
    ...
    },
    {
        ...
        params: [
            "SubOrders",
            {
                ...
                "delivery_status": {
                    "type": Sequelize.ENUM('not_approved', 'approved', 'picking', 'delay_picking', 'picked', 'not_picked', 'delivering', 'delivered', 'not_delivered', 'audited', 'cancelled'),
    ...
    },
    {
        ...
        params: [
            ...
            ["order_id"],
            {
                "indexName": "sub_orders_order_id",
                "name": "sub_orders_order_id"
            }
        ]
    },
    {
        ...
        params: [
            ...
            ["store_id"],
            {
                "indexName": "sub_orders_store_id",
                "name": "sub_orders_store_id"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        params: [
            ...
            ["sub_order_id"],
            {
                "indexName": "sub_orders_product_sub_order_id",
                "name": "sub_orders_product_sub_order_id"
            }
        ]
    },
    {
