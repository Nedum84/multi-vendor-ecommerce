...
interface CollectionCreationAttributes
  extends Optional<CollectionAttributes, "collection_id" | "image" | "status"> {}
...
export function CollectionFactory(sequelize: Sequelize) {
  const Collection = <ModelStatic<CollectionInstance>>sequelize.define(
    "Collection",
    CollectionModelAttributes as any,
    {
      timestamps: true,
