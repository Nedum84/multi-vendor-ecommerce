...
export interface CouponUserInstance
  extends Model<CouponUserAttributes, CouponUserAttributes>,
    CouponUserAttributes {}
...
export function CouponUserFactory(sequelize: Sequelize) {
  const CouponUser = <ModelStatic<CouponUserInstance>>sequelize.define(
    "CouponUser",
    CouponUserModelAttributes as any,
    {
      timestamps: false,
