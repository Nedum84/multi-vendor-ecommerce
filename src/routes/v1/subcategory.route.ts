...
router.post("", validate(subcategoryValidation.create), subcategoryController.create);
router.patch("/:sub_category_id", validate(subcategoryValidation.update), subcategoryController.update);
router.get("/:sub_category_id", validate(subcategoryValidation.findOne), subcategoryController.findOne);
router.get(
